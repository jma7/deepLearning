...
def draw_circles(image,cands,origin,spacing):
    ...
    for ca in cands:
        ...
        print(noduleRange,len(noduleRange))
        #create the mask
...
def create_nodule_mask(imagePath, maskPath, cands):
    ...
    print(lung_img.shape,lung_mask.shape,nodule_mask.shape)
    original_shape = nodule_mask.shape	
...
print(df_node["file"])
imagePath=df_node.iloc[0,5]
print(df_node.columns.values)
rownames=df_node.index.values
cands=[]
cands.append({"X":df_node.loc[rownames[0],"coordX"],"Y":df_node.loc[rownames[0],"coordY"],"Z":df_node.loc[rownames[0],"coordZ"],"diameter":df_node.loc[rownames[0],"diameter_mm"]})
